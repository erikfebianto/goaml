...
Partial Class MUserApproval
    Inherits Parent
    Public objFormModuleApproval As NawaBLL.FormModuleApproval
    Public Property ObjModule As NawaDAL.Module
        Get
            Return Session("MUserApproval.ObjModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("MUserApproval.ObjModule") = value
        End Set
    End Property
    Public Property strWhereClause() As String
        Get
            Return Session("MUserApproval.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("MUserApproval.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("MUserApproval.strSort")
        End Get
        Set(ByVal value As String)
            Session("MUserApproval.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("MUserApproval.indexStart")
        End Get
        Set(ByVal value As String)
            Session("MUserApproval.indexStart") = value
        End Set
    End Property
