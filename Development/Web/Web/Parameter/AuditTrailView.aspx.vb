...
Partial Class AuditTrailView
    ...
    Public Property strWhereClause() As String
        Get
            Return Session("AuditTrailHeader.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("AuditTrailHeader.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("AuditTrailHeader.strSort")
        End Get
        Set(ByVal value As String)
            Session("AuditTrailHeader.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("AuditTrailHeader.indexStart")
        End Get
        Set(ByVal value As String)
            Session("AuditTrailHeader.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                objFormModuleView.AddField("PK_AuditTrail_ID", "ID", 1, True, False, NawaBLL.Common.MFieldType.IDENTITY,,,, 10)
                objFormModuleView.AddField("CreatedDate", "Created Date", 2, False, True, NawaBLL.Common.MFieldType.DATETIMEValue, NawaBLL.SystemParameterBLL.GetDateFormat & " HH:mm:ss",,, 100)
                objFormModuleView.AddField("CreatedBy", "Created By", 3, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("ApproveBy", "Approve by", 4, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("ModuleLabel", "Module", 5, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("FK_ModuleAction_ID", "Module Action", 6, False, True, NawaBLL.Common.MFieldType.ReferenceTable, "ModuleAction", "PK_ModuleAction_ID", "ModuleActionName", "")
                objFormModuleView.AddField("FK_AuditTrailStatus_ID", "Status", 7, False, True, NawaBLL.Common.MFieldType.ReferenceTable, "AuditTrailStatus", "Pk_AuditTrailStatus_ID", "AuditTrailStatusName", "")
