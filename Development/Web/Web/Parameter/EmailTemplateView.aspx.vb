...
Partial Class EmailTemplateView
    Inherits Parent
    Public objFormModuleView As NawaBLL.FormModuleView
    Public Property strWhereClause() As String
        Get
            Return Session("EmailTemplateView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("EmailTemplateView.strSort")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("EmailTemplateView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateView.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                objFormModuleView.AddField("PK_EmailTemplate_ID", "ID", 1, True, True, NawaBLL.Common.MFieldType.IDENTITY)
                objFormModuleView.AddField("EmailTemplateName", "Email Template", 2, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("FK_Monitoringduration_ID", "Monitoring Duration", 3, False, True, NawaBLL.Common.MFieldType.ReferenceTable, "MonitoringDuration", "PK_MonitoringDuration_Id", "MonitoringDurationName", "")

                objFormModuleView.AddField("StartDate", "Start Date", 4, False, True, NawaBLL.Common.MFieldType.DATETIMEValue)
                objFormModuleView.AddField("StartTime", "Start Time", 5, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("ExcludeHoliday", "ExcludeHoliday", 6, False, True, NawaBLL.Common.MFieldType.BooleanValue)
                objFormModuleView.AddField("EmailTo", "Email To", 7, False, False, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("EmailCC", "Email CC", 8, False, False, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("EmailBCC", "Email BCC", 9, False, False, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("EmailSubject", "Email Subject", 10, False, False, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("EmailBody", "Email Body", 11, False, False, NawaBLL.Common.MFieldType.VARCHARValue)
