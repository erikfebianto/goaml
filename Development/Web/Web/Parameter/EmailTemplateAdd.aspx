<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="EmailTemplateAdd.aspx.vb" Inherits="EmailTemplateAdd" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <Items>
            <ext:FormPanel ID="FormPanelAdditional" runat="server" Padding="5" Title="Form" AnchorHorizontal="100%" Hidden="true" AutoScroll="true">
                <Items>
                    ...
                    <ext:ComboBox ID="cboTableType" runat="server" FieldLabel="Table Type" AllowBlank="false" EmptyText="Please Select Table Type" DisplayField="EmailTableTypeName" ValueField="PK_EmailTableType_ID" ForceSelection="true">
                        <Store>
    ...
    <ext:Window ID="WindowEmailAction" runat="server" ButtonAlign="Center" Collapsible="true" Height="185" Icon="Application" Title="Email Action" Width="350" Hidden="true">
        <Items>
        ...
        <Items>
            ...
            <ext:FormPanel ID="FormPanelEmailAttachment" runat="server" Padding="5" Layout="AnchorLayout">
                <Items>
                    ...
                    <ext:TextField ID="TxtReportName" runat="server" FieldLabel="Report Name" AnchorHorizontal="80%" EmptyText="Please Fill Report Name" Hidden="true">
                    </ext:TextField>
