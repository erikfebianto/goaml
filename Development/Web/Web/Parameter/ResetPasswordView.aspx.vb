...
Partial Class ResetPasswordView
    ...
    Public Property strWhereClause() As String
        Get
            Return Session("ResetPasswordView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("ResetPasswordView.strSort")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("ResetPasswordView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordView.indexStart") = value
        End Set
    End Property
