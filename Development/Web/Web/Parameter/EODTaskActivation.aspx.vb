Imports Ext.Net
Partial Class EODTaskActivation
    Inherits Parent

#Region "Session"
    Public Property StrUnikKey() As String
        Get
            Return Session("EODTaskActivation.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("EODTaskActivation.StrUnikKey") = value
        End Set
    End Property
    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("EODTaskActivation.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EODTaskActivation.objmodule") = value
        End Set
    End Property
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not Ext.Net.X.IsAjaxRequest Then
                ...
                objEODTaskBLL.LoadPanelActivation(FormPanelInput, objmodule.ModuleName, StrUnikKey)
            End If
                ...
                Case "Delete"
                    If NawaBLL.EODTaskBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            objEODTaskBLL.ActivationTanpaapproval(StrUnikKey, objmodule)
                            LblConfirmation.Text = "Data  Activation " & objmodule.ModuleLabel & " is Changed."
                        Else
                            objEODTaskBLL.ActivationDenganapproval(StrUnikKey, objmodule)
                            LblConfirmation.Text = "Data Activation " & objmodule.ModuleLabel & " Saved into Pending Approval"
                        End If
