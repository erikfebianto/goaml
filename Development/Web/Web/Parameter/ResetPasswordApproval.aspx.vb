...
Partial Class ResetPasswordApproval
    Inherits Parent
    Public objFormModuleApproval As NawaBLL.FormModuleApproval
    Public Property ObjModule As NawaDAL.Module
        Get
            Return Session("ResetPasswordApproval.ObjModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("ResetPasswordApproval.ObjModule") = value
        End Set
    End Property
    Public Property strWhereClause() As String
        Get
            Return Session("ResetPasswordApproval.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordApproval.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("ResetPasswordApproval.strSort")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordApproval.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("ResetPasswordApproval.indexStart")
        End Get
        Set(ByVal value As String)
            Session("ResetPasswordApproval.indexStart") = value
        End Set
    End Property
