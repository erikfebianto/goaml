...
Partial Class MUserDelete
    ...
    Public Property StrUnikKey() As String
        Get
            Return Session("MUserDelete.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("MUserDelete.StrUnikKey") = value
        End Set
    End Property
    ...
    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("MUserDelete.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("MUserDelete.objmodule") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                NawaBLL.MUserBLL.LoadPanel(FormPanelInput, objmodule.ModuleName, StrUnikKey)
                ...
                Case "Delete"
                    If NawaBLL.MUserBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            ...
                            NawaBLL.MUserBLL.DeleteTanpaapproval(StrUnikKey, objmodule)

                            Panelconfirmation.Visible = True
                            LblConfirmation.Text = "Data User " & objmodule.ModuleLabel & " is deleted."
