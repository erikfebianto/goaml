...
Partial Class MUserView
    Inherits Parent
    Public objFormModuleView As NawaBLL.FormModuleView
    Public Property strWhereClause() As String
        Get
            Return Session("MUserView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("MUserView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("MUserView.strSort")
        End Get
        Set(ByVal value As String)
            Session("MUserView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("MUserView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("MUserView.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                'objFormModuleView.AddField("UserEmailAddress", "Email Address", 6, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
