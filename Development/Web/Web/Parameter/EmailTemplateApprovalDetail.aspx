<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="EmailTemplateApprovalDetail.aspx.vb" Inherits="EmailTemplateApprovalDetail" %>
        ...
        <Items>
            <ext:FormPanel ID="PanelInfo" runat="server" Title="Module Approval" BodyPadding="10">
                <Items>
                    ...
                    <ext:DisplayField ID="lblCreatedDate" runat="server" FieldLabel="Created Date" Margin="0">
                    </ext:DisplayField>
                </Items>
            </ext:FormPanel>
