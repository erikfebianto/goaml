<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="AuditTrailView.aspx.vb" Inherits="AuditTrailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:GridPanel ID="GridpanelView" runat="server" Title="Title" ForceFit="true"    >
        <View>
