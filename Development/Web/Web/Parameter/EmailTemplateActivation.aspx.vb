Imports Ext.Net
Partial Class EmailTemplateActivation
    Inherits Parent

    Public Property StrUnikKey() As String
        Get
            Return Session("EmailTemplateActivation.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateActivation.StrUnikKey") = value
        End Set
    End Property

    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("EmailTemplateActivation.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EmailTemplateActivation.objmodule") = value
        End Set
    End Property
        ...
        Try
            ...
            Try
                ...
                If Not Ext.Net.X.IsAjaxRequest Then
                    ...
                    NawaBLL.EmailTemplateBLL.LoadPanelActivation(FormPanelInput, objmodule.ModuleName, StrUnikKey)
                End If
                ...
                Case "Activation"
                    ...
                    If NawaBLL.EmailTemplateBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            ...
                            NawaBLL.EmailTemplateBLL.ActivationTanpaapproval(StrUnikKey, objmodule)
                        ...
                        Else
                            ...
                            NawaBLL.EmailTemplateBLL.ActivationDenganapproval(StrUnikKey, objmodule)
