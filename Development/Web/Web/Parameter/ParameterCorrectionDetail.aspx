<%@ page title="" language="VB" masterpagefile="~/Site1.master" autoeventwireup="false" inherits="ParameterCorrectionDetail, App_Web_parametercorrectiondetail.aspx.252c98" %>
    ...
    <ext:Panel ID="container" runat="server" Layout="FormLayout" AutoScroll="true"  ButtonAlign="Center" >
       ...
       <Buttons>
            <ext:Button ID="btnSave" ClientIDMode="Static" runat="server" Text="Save" Enabled="false" Icon="DiskBlack">
                <Listeners>
                    <Click Handler="if (!#{FormPanelNew}.getForm().isValid()) return false;"></Click>
                </Listeners>
                <DirectEvents>
                    <Click OnEvent="Callback">
                        <ExtraParams>
                            <ext:Parameter Name="command" Value="Edit" Mode="Value">
                            </ext:Parameter>
