...
Partial Class EmailTemplateApproval
    Inherits Parent
    Public objFormModuleApproval As NawaBLL.FormModuleApproval
    Public Property ObjModule As NawaDAL.Module
        Get
            Return Session("EmailTemplateApproval.ObjModule")
        End Get
        Set(value As NawaDAL.Module)
            Session("EmailTemplateApproval.ObjModule") = value
        End Set
    End Property
    Public Property strWhereClause() As String
        Get
            Return Session("EmailTemplateApproval.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateApproval.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("EmailTemplateApproval.strSort")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateApproval.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("EmailTemplateApproval.indexStart")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateApproval.indexStart") = value
        End Set
    End Property
