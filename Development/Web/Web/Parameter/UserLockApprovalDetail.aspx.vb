Imports Ext.Net
Partial Class UserLockApprovalDetail
    Inherits Parent

    Public Property ObjApproval() As NawaDAL.ModuleApproval
        Get
            Return Session("UserLockApprovalDetail.ObjApproval")
        End Get
        Set(ByVal value As NawaDAL.ModuleApproval)
            Session("UserLockApprovalDetail.ObjApproval") = value
        End Set
    End Property
    Public Property objSchemaModule() As NawaDAL.Module
        Get
            Return Session("UserLockApprovalDetail.objSchemaModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("UserLockApprovalDetail.objSchemaModule") = value
        End Set
    End Property
            ...
            If Not Ext.Net.X.IsAjaxRequest Then
                ...
                Select Case ObjApproval.PK_ModuleAction_ID
                    Case NawaBLL.Common.ModuleActionEnum.Insert
                        ...
                        Dim objNew As New NawaDevBLL.UserLockBLL
    ...
    Protected Sub BtnSave_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.UserLockBLL.Accept(ObjApproval.PK_ModuleApproval_ID)
    ...
    Protected Sub BtnReject_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.UserLockBLL.Reject(ObjApproval.PK_ModuleApproval_ID)
