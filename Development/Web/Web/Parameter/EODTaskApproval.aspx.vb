...
Partial Class EODTaskApproval
    Inherits Parent
    Public objFormModuleApproval As NawaBLL.FormModuleApproval
    Public Property ObjModule As NawaDAL.Module
        Get
            Return Session("EODTaskApproval.ObjModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EODTaskApproval.ObjModule") = value
        End Set
    End Property
    Public Property strWhereClause() As String
        Get
            Return Session("EODTaskApproval.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("EODTaskApproval.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("EODTaskApproval.strSort")
        End Get
        Set(ByVal value As String)
            Session("EODTaskApproval.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("EODTaskApproval.indexStart")
        End Get
        Set(ByVal value As String)
            Session("EODTaskApproval.indexStart") = value
        End Set
    End Property
