Imports Ext.Net
Partial Class EODSchedulerApprovalDetail
    Inherits Parent

    Public Property ObjApproval() As NawaDAL.ModuleApproval
        Get
            Return Session("EODSchedulerApprovalDetail.ObjApproval")
        End Get
        Set(ByVal value As NawaDAL.ModuleApproval)
            Session("EODSchedulerApprovalDetail.ObjApproval") = value
        End Set
    End Property
    Public Property objSchemaModule() As NawaDAL.Module
        Get
            Return Session("EODSchedulerApprovalDetail.objSchemaModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EODSchedulerApprovalDetail.objSchemaModule") = value
        End Set
    End Property
            ...
            If Not Ext.Net.X.IsAjaxRequest Then
                ...
                Select Case ObjApproval.PK_ModuleAction_ID
                    Case NawaBLL.Common.ModuleActionEnum.Insert
                        ...
                        Dim objNewEODTask As New NawaBLL.EODSchedulerBLL
                    ...
                    Case NawaBLL.Common.ModuleActionEnum.Delete
                        ...
                        Dim objNewMGroupAccess As New NawaBLL.EODSchedulerBLL
    ...
    Protected Sub BtnSave_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaBLL.EODSchedulerBLL.Accept(ObjApproval.PK_ModuleApproval_ID)
    ...
    Protected Sub BtnReject_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaBLL.EODSchedulerBLL.Reject(ObjApproval.PK_ModuleApproval_ID)
