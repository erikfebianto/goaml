<%@ page title="" language="vb" autoeventwireup="false" masterpagefile="~/Site1.Master" inherits="ModuleEdit, App_Web_moduleedit.aspx.252c98" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:Window ID="WindowDetail" runat="server" Icon="ApplicationViewDetail" Title="Module field" Hidden="true" Layout="FitLayout" Modal="true">
        <Items>
            <ext:FormPanel ID="FormPanelField" runat="server" ButtonAlign="Center" Padding="5"  AutoScroll="true">
                <Items>
    ...
    <ext:FormPanel ID="FormPanelInput" runat="server" ButtonAlign="Center" Title="Module Designer" BodyStyle="padding:20px" AutoScroll="true">
        <Items>
            <ext:DisplayField ID="IDModule" runat="server" Text="" FieldLabel="Module ID">
            </ext:DisplayField>
            ...
            <ext:FieldSet ID="FieldContainerModuleField" runat="server" Title="ModuleField" Hidden="true">
                <Items>

                    <ext:GridPanel ID="GridPanelModuleField" Padding="5" runat="server" Title="Module Field List" AutoScroll="true" Height="400">
                        <TopBar>
