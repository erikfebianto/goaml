Imports Ext.Net
Partial Class EmailTemplateDetail
    Inherits Parent

    Public Property StrUnikKey() As String
        Get
            Return Session("EmailTemplateDetail.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("EmailTemplateDetail.StrUnikKey") = value
        End Set
    End Property

    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("EmailTemplateDetail.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EmailTemplateDetail.objmodule") = value
        End Set
    End Property
