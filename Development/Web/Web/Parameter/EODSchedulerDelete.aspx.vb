Imports Ext.Net
Partial Class EODSchedulerDelete
    Inherits Parent

    Public Property StrUnikKey() As String
        Get
            Return Session("EODSchedulerDelete.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("EODSchedulerDelete.StrUnikKey") = value
        End Set
    End Property

    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("EODSchedulerDelete.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("EODSchedulerDelete.objmodule") = value
        End Set
    End Property
        ...
        Try
            ...
            Try
                ...
                If Not Ext.Net.X.IsAjaxRequest Then
                    ...
                    NawaBLL.EODSchedulerBLL.LoadPanelDelete(FormPanelInput, objmodule.ModuleName, StrUnikKey)
                End If
                ...
                Case "Delete"
                    ...
                    If NawaBLL.EODSchedulerBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            ...
                            NawaBLL.EODSchedulerBLL.DeleteTanpaapproval(StrUnikKey, objmodule)
                        ...
                        Else
                            ...
                            NawaBLL.EODSchedulerBLL.DeleteDenganapproval(StrUnikKey, objmodule)
