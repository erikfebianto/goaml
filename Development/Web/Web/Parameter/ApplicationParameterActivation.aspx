<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="ApplicationParameterActivation.aspx.vb" Inherits="ApplicationParameterActivation" %>
    ...
    <ext:FormPanel ID="FormPanelInput" runat="server" ButtonAlign="Center" Title="" BodyStyle="padding:20px" AutoScroll="true"  >
        <Items>
            <ext:DisplayField ID="txtID" runat="server" Text="AutoNumber" FieldLabel="ID">
              ...
              <ext:DisplayField ID="txtValue" runat="server" Text="Value" FieldLabel="Setting Name">
            </ext:DisplayField>


              <ext:DisplayField ID="txtActivation" runat="server" Text="" FieldLabel="Activation">
            </ext:DisplayField>
        </Items>
        <Buttons>
