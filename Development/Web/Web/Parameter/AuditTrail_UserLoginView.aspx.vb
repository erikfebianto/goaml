...
Partial Class AuditTrail_UserLoginView
    Inherits Parent
    Public objFormModuleView As NawaBLL.FormModuleView
    Public Property strWhereClause() As String
        Get
            Return Session("AuditTrail_UserLoginView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserLoginView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("AuditTrail_UserLoginView.strSort")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserLoginView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("AuditTrail_UserLoginView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserLoginView.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                objFormModuleView.AddField("UserLoginID", "ID", 1, True, True, NawaBLL.Common.MFieldType.IDENTITY)
                objFormModuleView.AddField("UserLoginActionDate", "Action Date", 2, False, True, NawaBLL.Common.MFieldType.DATETIMEValue, NawaBLL.SystemParameterBLL.GetDateFormat & " HH:mm:ss")
                objFormModuleView.AddField("UserLoginUserid", "User ID", 3, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("UserLoginAction", "Action", 4, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("UserLoginIPAddress", "IP Address", 5, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
