<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="EODProcessManualBranch.aspx.vb" Inherits="EODProcessManualBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ext:FormPanel ID="FormPanelInput" runat="server" ButtonAlign="Center" Title="" BodyStyle="padding:20px" AutoScroll="true" Layout="AnchorLayout">
        <Items>
            <ext:DateField ID="DeStartDate" runat="server" FieldLabel="Process For Report Date" LabelWidth="160" AllowBlank="false"></ext:DateField>
            <ext:ComboBox ID="CboProcess" runat="server" FieldLabel="Process" AnchorHorizontal="80%" DisplayField="EODSchedulerName" ValueField="PK_EODScheduler_ID" MinChars="0" 
                ForceSelection="true" TriggerAction="Query" AllowBlank="false" BlankText="Process is required" LabelWidth="160">
                <Store>
            ...
            <ext:DropDownField ID="CboTask" runat="server" Editable="false" TriggerIcon="SimpleArrowDown" FieldLabel="List Task" AnchorHorizontal="80%" 
                AllowBlank="false" ClientIDMode="Static" Mode="ValueText" LabelWidth="160">
                <Listeners>
                    <Expand Handler="this.picker.setWidth(600);" />
                </Listeners>
                <Component>
                    <ext:TreePanel runat="server" Title="Picker Process" Icon="Accept" Height="300" Width="300" Shadow="false" UseArrows="true" AutoScroll="true"
                        Animate="true" Enabled="true" ContainerScroll="true" RootVisible="false" ID="Treecombo1" Frame="true" ClientIDMode="Static">
                        <TopBar>
