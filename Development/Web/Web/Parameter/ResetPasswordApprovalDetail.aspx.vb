Imports Ext.Net
Partial Class ResetPasswordApprovalDetail
    Inherits Parent

    Public Property ObjApproval() As NawaDAL.ModuleApproval
        Get
            Return Session("ResetPasswordApprovalDetail.ObjApproval")
        End Get
        Set(ByVal value As NawaDAL.ModuleApproval)
            Session("ResetPasswordApprovalDetail.ObjApproval") = value
        End Set
    End Property
    Public Property objSchemaModule() As NawaDAL.Module
        Get
            Return Session("ResetPasswordApprovalDetail.objSchemaModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("ResetPasswordApprovalDetail.objSchemaModule") = value
        End Set
    End Property
            ...
            If Not Ext.Net.X.IsAjaxRequest Then
                ...
                Select Case ObjApproval.PK_ModuleAction_ID
                    Case NawaBLL.Common.ModuleActionEnum.Insert
                        ...
                        Dim objNew As New NawaDevBLL.ResetPasswordBLL
                        objNew.LoadPanel(FormPanelNew, ObjApproval.ModuleField, ObjApproval.ModuleName, unikkey)

                    Case NawaBLL.Common.ModuleActionEnum.Delete
                        Dim unikID As String = Guid.NewGuid.ToString
                        Dim objNew As New NawaDevBLL.ResetPasswordBLL
                        objNew.LoadPanel(FormPanelNew, ObjApproval.ModuleField, ObjApproval.ModuleName, unikID)
                    ...
                    Case NawaBLL.Common.ModuleActionEnum.Update
                        ...
                        Dim objNew As New NawaDevBLL.ResetPasswordBLL
                        objNew.LoadPanel(FormPanelNew, ObjApproval.ModuleField, ObjApproval.ModuleName, unikkeyNew)
                        objNew.LoadPanel(FormPanelOld, ObjApproval.ModuleFieldBefore, ObjApproval.ModuleName, unikkeyOld)
    ...
    Protected Sub BtnSave_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.ResetPasswordBLL.Accept(ObjApproval.PK_ModuleApproval_ID)
    ...
    Protected Sub BtnReject_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.ResetPasswordBLL.Reject(ObjApproval.PK_ModuleApproval_ID)
