<%@ page title="" language="VB" masterpagefile="~/Site1.Master" autoeventwireup="false" inherits="ReportQueryAdd, App_Web_reportqueryadd.aspx.252c98" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:FormPanel ID="FormPanelInput" runat="server" ButtonAlign="Center" Title="" BodyStyle="padding:20px" AutoScroll="true">
        <Items>
            ...
            <ext:TextArea ID="txtquery" ClientIDMode="Static" runat="server" AllowBlank="false" AnchorHorizontal="80%" AnchorVertical="70%" FieldLabel="Query" AutoScroll="True" Resizable="True">
            </ext:TextArea>
        ...
        <Buttons>
            <ext:Button ID="btnSave" runat="server" Icon="Disk" Text="Save Report Query">
                <Listeners>
