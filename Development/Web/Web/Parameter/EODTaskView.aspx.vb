...
Partial Class EODTaskView
    Inherits Parent
    Public objFormModuleView As NawaBLL.FormModuleView
    Public Property strWhereClause() As String
        Get
            Return Session("EODTaskView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("EODTaskView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("EODTaskView.strSort")
        End Get
        Set(ByVal value As String)
            Session("EODTaskView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("EODTaskView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("EODTaskView.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                objFormModuleView.AddField("PK_EODTask_ID", "ID", 1, True, True, NawaBLL.Common.MFieldType.IDENTITY)
                objFormModuleView.AddField("EODTaskName", "Task Name", 2, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("EODTaskDescription", "Task Description", 3, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
