...
Partial Class AuditTrail_UserAccessView
    Inherits Parent
    Public objFormModuleView As NawaBLL.FormModuleView
    Public Property strWhereClause() As String
        Get
            Return Session("AuditTrail_UserAccessView.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserAccessView.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("AuditTrail_UserAccessView.strSort")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserAccessView.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("AuditTrail_UserAccessView.indexStart")
        End Get
        Set(ByVal value As String)
            Session("AuditTrail_UserAccessView.indexStart") = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Try
                ...
                objFormModuleView.AddField("PK_UserAccessID", "ID", 1, True, True, NawaBLL.Common.MFieldType.IDENTITY)
                objFormModuleView.AddField("ActionDate", "Action Date", 2, False, True, NawaBLL.Common.MFieldType.DATETIMEValue, NawaBLL.SystemParameterBLL.GetDateFormat & " HH:mm:ss")
                objFormModuleView.AddField("Userid", "User ID", 3, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
                objFormModuleView.AddField("Action", "Action", 4, False, True, NawaBLL.Common.MFieldType.VARCHARValue)
