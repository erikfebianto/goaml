<%@ WebHandler Language="VB" Class="DownloadLHBUSourceFile" %>
...
Public Class DownloadLHBUSourceFile : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Using objDb As NawaDevDAL.NawaDatadevEntities = New NawaDevDAL.NawaDatadevEntities
            ...
            If Not objdownload Is Nothing Then
                ...
                context.Response.AddHeader("Content-Disposition", "attachment;filename=" & objdownload.FileName)
                context.Response.Charset = Encoding.UTF8.WebName
                context.Response.ContentEncoding = Encoding.UTF8
                context.Response.AddHeader("cache-control", "max-age=0")
                context.Response.ContentType = "text/plain"
                context.Response.BinaryWrite(objdownload.Data)
