...
Partial Class GenerateFileTemplateApproval
    Inherits Parent
    Public objFormModuleApproval As NawaBLL.FormModuleApproval
    Public Property ObjModule As NawaDAL.Module
        Get
            Return Session("GenerateFileTemplateApproval.ObjModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("GenerateFileTemplateApproval.ObjModule") = value
        End Set
    End Property
    Public Property strWhereClause() As String
        Get
            Return Session("GenerateFileTemplateApproval.strWhereClause")
        End Get
        Set(ByVal value As String)
            Session("GenerateFileTemplateApproval.strWhereClause") = value
        End Set
    End Property
    Public Property strOrder() As String
        Get
            Return Session("GenerateFileTemplateApproval.strSort")
        End Get
        Set(ByVal value As String)
            Session("GenerateFileTemplateApproval.strSort") = value
        End Set
    End Property
    Public Property indexStart() As String
        Get
            Return Session("GenerateFileTemplateApproval.indexStart")
        End Get
        Set(ByVal value As String)
            Session("GenerateFileTemplateApproval.indexStart") = value
        End Set
    End Property
