Imports Ext.Net
Partial Class GenerateFileTemplateApprovalDetail
    Inherits Parent

    Public Property ObjApproval() As NawaDAL.ModuleApproval
        Get
            Return Session("GenerateFileTemplateApprovalDetail.ObjApproval")
        End Get
        Set(ByVal value As NawaDAL.ModuleApproval)
            Session("GenerateFileTemplateApprovalDetail.ObjApproval") = value
        End Set
    End Property
    Public Property objSchemaModule() As NawaDAL.Module
        Get
            Return Session("GenerateFileTemplateApprovalDetail.objSchemaModule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("GenerateFileTemplateApprovalDetail.objSchemaModule") = value
        End Set
    End Property
            ...
            If Not Ext.Net.X.IsAjaxRequest Then
                ...
                Select Case ObjApproval.PK_ModuleAction_ID
                    Case NawaBLL.Common.ModuleActionEnum.Insert
                        ...
                        Dim objNew As New NawaDevBLL.FileGenerationBLL
    ...
    Protected Sub BtnSave_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.FileGenerationBLL.Accept(ObjApproval.PK_ModuleApproval_ID)
    ...
    Protected Sub BtnReject_Click(sender As Object, e As Ext.Net.DirectEventArgs)
        Try
            NawaDevBLL.FileGenerationBLL.Reject(ObjApproval.PK_ModuleApproval_ID)
