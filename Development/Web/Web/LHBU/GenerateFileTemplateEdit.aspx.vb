...
Imports System.Data
Partial Class GenerateFileTemplateEdit
    Inherits Parent
    ...
    Public Property objListGenerateFileTemplateAdditionalAdd() As List(Of NawaDevDAL.GenerateFileTemplateAdditional)
        Get
            If Session("GenerateFileTemplateAdd.objListGenerateFileTemplateAdditionalAdd") Is Nothing Then
                ...
                Dim oNewScheduler As List(Of NawaDevDAL.GenerateFileTemplateAdditional) = NawaDevBLL.FileGenerationBLL.GetListGenerateFileTemplateAdditionalByPKID(id)
    ...
    Public Property objListGenerateFileTemplateDetailAdd() As List(Of NawaDevDAL.GenerateFileTemplateDetail)
        Get
            If Session("GenerateFileTemplateAdd.objListGenerateFileTemplateDetailAdd") Is Nothing Then
                ...
                Dim oNewScheduler As List(Of NawaDevDAL.GenerateFileTemplateDetail) = NawaDevBLL.FileGenerationBLL.GetListGenerateFileTemplateDetailByPKID(id)
    ...
    Public Property objGenerateFileTemplateAddData() As NawaDevDAL.GenerateFileTemplate
        Get
            If Session("GenerateFileTemplateAdd.objGenerateFileTemplateAddData") Is Nothing Then
                ...
                Session("GenerateFileTemplateAdd.objGenerateFileTemplateAddData") = NawaDevBLL.FileGenerationBLL.GetGenerateFileTemplateByID(id)
            End If
    ...
    End Sub
    Sub LoadData()
        If Not objGenerateFileTemplateAddData Is Nothing Then
            With objGenerateFileTemplateAddData
                txtGenerateFileTemplate.Text = .GenerateFileTemplateName
                txtFileNameFormat.Text = .FileNameFormat
                CbOJKSegmenData.SetValueAndFireSelect(.LHBUFormName)
                CbDelivMethod.SetValueAndFireSelect(.FK_DelivMethod_ID)
                txtBody.Text = .OutputFormat
            End With
    ...
    Sub SaveAddGenerateFileTemplateDetail()
        ...
        objnewGenerateFileTemplateDetail.FK_GenerationFileTemplate_ID = objGenerateFileTemplateAddData.PK_GenerationFileTemplate_ID
    ...
    Sub LoadDataEditAdditional(id As Long)
        ...
        If Not objGenerateFileTemplateAdditionalEdit Is Nothing Then
            ...
            With objGenerateFileTemplateAdditionalEdit
                ...
                'txtSeq.Text = .Sequence
                'cbBulan.SetValueAndFireSelect(.FieldBulan)
                'cbTahun.SetValueAndFireSelect(.FieldTahun)
    ...
    Public Function IsDataAddValid() As Boolean
        Try
            ...
            If objGenerateFileTemplateBLL.IsApprovalExists(CStr(objGenerateFileTemplateAddData.PK_GenerationFileTemplate_ID)) Then
                Throw New Exception("Generate File Template Name " & txtGenerateFileTemplate.Text.Trim & " is waiting for approval.")
            End If
            '
            'End If
        ...
        Try
            If IsDataAddValid() Then
                ...
                If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID.ToString = 1 OrElse Not (ObjModule.IsUseApproval) Then
                    objGenerateFileTemplateBLL.SaveEditTanpaApproval(objGenerateFileTemplateAddData, objListGenerateFileTemplateAdditionalAdd, objListGenerateFileTemplateDetailAdd, ObjModule)
                    Panelconfirmation.Hidden = False
                    FormPanelInput.Hidden = True
                    LblConfirmation.Text = "Data Saved into Database"
                Else
                    objGenerateFileTemplateBLL.SaveEditApproval(objGenerateFileTemplateAddData, objListGenerateFileTemplateAdditionalAdd, objListGenerateFileTemplateDetailAdd, ObjModule)
                    Panelconfirmation.Hidden = False
                    FormPanelInput.Hidden = True
