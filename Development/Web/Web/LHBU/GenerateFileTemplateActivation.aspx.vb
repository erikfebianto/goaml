Imports Ext.Net
Partial Class GenerateFileTemplateActivation
    Inherits Parent

    Public Property StrUnikKey() As String
        Get
            Return Session("GenerateFileTemplateActivation.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("GenerateFileTemplateActivation.StrUnikKey") = value
        End Set
    End Property

    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("GenerateFileTemplateActivation.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("GenerateFileTemplateActivation.objmodule") = value
        End Set
    End Property
        ...
        Try
            ...
            Try
                ...
                If Not Ext.Net.X.IsAjaxRequest Then
                    ...
                    NawaDevBLL.FileGenerationBLL.LoadPanelActivation(FormPanelInput, objmodule.ModuleName, StrUnikKey)
                End If
        ...
        Try
            Select Case e.ExtraParams("command")
                Case "Activation"
                    ...
                    If NawaDevBLL.FileGenerationBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            ...
                            NawaDevBLL.FileGenerationBLL.ActivationTanpaapproval(StrUnikKey, objmodule)
                        ...
                        Else
                            ...
                            NawaDevBLL.FileGenerationBLL.ActivationDenganapproval(StrUnikKey, objmodule)
