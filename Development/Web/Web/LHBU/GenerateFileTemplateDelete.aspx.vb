Imports Ext.Net
Partial Class GenerateFileTemplateDelete
    Inherits Parent

    Public Property StrUnikKey() As String
        Get
            Return Session("GenerateFileTemplateDelete.StrUnikKey")
        End Get
        Set(ByVal value As String)
            Session("GenerateFileTemplateDelete.StrUnikKey") = value
        End Set
    End Property

    Public Property objmodule() As NawaDAL.Module
        Get
            Return Session("GenerateFileTemplateDelete.objmodule")
        End Get
        Set(ByVal value As NawaDAL.Module)
            Session("GenerateFileTemplateDelete.objmodule") = value
        End Set
    End Property
        ...
        Try
            ...
            Try
                ...
                If Not Ext.Net.X.IsAjaxRequest Then
                    ...
                    NawaDevBLL.FileGenerationBLL.LoadPanelDelete(FormPanelInput, objmodule.ModuleName, StrUnikKey)
                End If
                ...
                Case "Delete"
                    ...
                    If NawaDevBLL.FileGenerationBLL.IsDataValidDelete(StrUnikKey, objmodule) Then
                        ...
                        If NawaBLL.Common.SessionCurrentUser.FK_MRole_ID = 1 OrElse Not objmodule.IsUseApproval Then
                            ...
                            NawaDevBLL.FileGenerationBLL.DeleteTanpaapproval(StrUnikKey, objmodule)
                        ...
                        Else
                            ...
                            NawaDevBLL.FileGenerationBLL.DeleteDenganapproval(StrUnikKey, objmodule)
