<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="GenerateFileTemplateEdit.aspx.vb" Inherits="GenerateFileTemplateEdit" ValidateRequest="false" %>
                    ...
                    <ext:GridPanel ID="GridPanelAdditional" runat="server" Title="Table Reference">
                        ...
                        <ColumnModel>
                            <Columns>
                                ...
                                <ext:Column ID="Column5" runat="server" DataIndex="OutputFormat" Text="Output Format" Flex="1" Hidden="true"/>
