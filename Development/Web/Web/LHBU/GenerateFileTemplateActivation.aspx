<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="GenerateFileTemplateActivation.aspx.vb" Inherits="GenerateFileTemplateActivation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ext:FormPanel ID="FormPanelInput" BodyPadding="20" runat="server" ClientIDMode="Static" Border="false" Frame="false"  ButtonAlign="Center" DefaultAnchor="100%" AutoScroll="true" Flex="1"> 
        ...
        <Buttons>
            <ext:Button ID="btnSave" ClientIDMode="Static" runat="server" Text="Activation" Icon="DiskBlack">
                <Listeners>
