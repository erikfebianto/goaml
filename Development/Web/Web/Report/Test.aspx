<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="Test.aspx.vb" Inherits="RWA_Test" %>
    ...
    <ext:FormPanel ID="FormPanel1" runat="server" Padding="5" AutoScroll="true" Layout="FormLayout">
        ...
        <Items>
            <ext:Container ID="Container1" runat="server" Layout="FormLayout" BodyPadding="5" AnchorHorizontal="70%">
                ...
                <Items>
                    <ext:NumberField ID="NumberField1" runat="server" KeyNavEnabled="false" MouseWheelEnabled="false">
