<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.Master" AutoEventWireup="false" CodeFile="ReportRWA2A.aspx.vb" Inherits="Report_ReportRWA2A" %>
        ...
        <Items>
            <ext:Container ID="ContainerDocStatus" runat="server" Border="true" MarginSpec="0 0 10 10">
                <Items>
                    ...
                    <ext:Panel runat="server" ID="PanelReport" Collapsible="true" AutoScroll="true" Hidden="false" Title="Report 1A" TitleAlign="Center">
                        <Content>
                            ...
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="300px" ShowRefreshButton="true" Width="100%">
                                <LocalReport ReportPath="Report\ReportLocal\Report1A.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                        </Content>
                    </ext:Panel>
