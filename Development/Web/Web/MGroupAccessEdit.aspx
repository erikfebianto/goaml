<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeFile="MGroupAccessEdit.aspx.vb" Inherits="MGroupAccessEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:Panel ID="Panel1" runat="server" Layout="BorderLayout" Flex="1">
        <Items>
                        ...
                        <TopBar>
                            <ext:Toolbar ID="Toolbar1" runat="server" EnableOverflow="true">
                                <Items>
                                    ...
                                    <ext:Checkbox ID="btnSelectAll" ClientIDMode="Static" runat="server" Text="Select All" BoxLabel="Select ALL Current Page">
                                        <Listeners>
                    ...
                    <Change OnEvent="ChangePage"></Change>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="ColModuleLabel" runat="server" DataIndex="ModuleLabel" Width="200" Text="Sub Module"></ext:Column>
                        ...
                        <Buttons>
                            <ext:Button ID="btnSaveData" runat="server" Text="Save All Group Menu Access">
                                <DirectEvents>
            ...
            <ext:Panel ID="Panel2" runat="server" Title="Detail" Layout="VBoxLayout" Region="East" Flex="1" Collapsible="true" Collapsed="true">
                <LayoutConfig>
