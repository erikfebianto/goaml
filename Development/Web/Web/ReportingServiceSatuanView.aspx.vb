...
Partial Class ReportingServiceSatuanView
    Inherits ParentPage
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                For Each item As CatalogItem In objitem
                    If item.TypeName = "Report" And item.Name = ObjModule.ModuleName Then
                        strpath = item.Path
    ...
    Sub LoadDataReport()
        ...
        objitem = objreport.ListChildren("/", True)
        For Each item As CatalogItem In objitem
            If item.TypeName = "Report" And item.Name.ToLower = ObjModule.ModuleName.ToLower Then
