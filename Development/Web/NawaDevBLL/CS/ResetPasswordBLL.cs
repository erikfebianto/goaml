...
{
	[Serializable()]public class ResetPasswordBLL : IDisposable
	{
		...
		public static bool EditPaswordDirect(string strUserid, string strPassword)
		{
		...
		public static bool EditPaswordApproval(string strUserid, string strPassword, NawaDAL.Module objModule)
		{
		...
		{
			NawaDAL.MUser objResetPasswordBLL = NawaBLL.Common.Deserialize(objdata, typeof(NawaDAL.MUser));
			if (!ReferenceEquals(objResetPasswordBLL, null))
			{
				string strunik = unikkey;
				NawaBLL.Nawa.BLL.NawaFramework.ExtDisplayField(objPanel, "ID", "PK_MUser_ID" + strunik, System.Convert.ToString(objResetPasswordBLL.PK_MUser_ID));
				NawaBLL.Nawa.BLL.NawaFramework.ExtDisplayField(objPanel, "User ID", "UserID" + strunik, objResetPasswordBLL.UserID);
				NawaBLL.Nawa.BLL.NawaFramework.ExtDisplayField(objPanel, "Staff Name", "UserName" + strunik, objResetPasswordBLL.UserName);
				NawaBLL.Nawa.BLL.NawaFramework.ExtDisplayField(objPanel, "User Pasword", "UserPasword" + strunik, objResetPasswordBLL.UserPasword);
				NawaBLL.Nawa.BLL.NawaFramework.ExtDisplayField(objPanel, "Active", "Active" + strunik, objResetPasswordBLL.Active);
