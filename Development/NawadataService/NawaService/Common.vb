...
Module Common
    ...
    Public Function GetSystemParameter(ByVal parameterid As Integer) As SystemParameter

        Using objDb As NawaDataEntities = New NawaDataEntities
            Dim objsysparam As SystemParameter = objDb.SystemParameters.Where(Function(x) x.PK_SystemParameter_ID = parameterid).FirstOrDefault
            Return objsysparam
        End Using
    End Function
